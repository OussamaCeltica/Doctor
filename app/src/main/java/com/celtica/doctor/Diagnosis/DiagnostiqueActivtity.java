...
import com.celtica.doctor.SEXE;
...
public class DiagnostiqueActivtity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BodyLocation.getBodyLocation(new PostServerRequest5.doBeforAndAfterGettingData() {
            @Override
            public void before() {
                progress=GlobalVar.WaitScreenAds(DiagnostiqueActivtity.this,"","Loading ..");
            }
        ...
        ((CardView)findViewById(R.id.diag_testButt)).setOnClickListener((view -> {
            ...
            if (!GlobalVar.getInstance().user.diagnoValideQuotas())
                Toast.makeText(getApplicationContext(),"You must pay your Contract to continue ..",Toast.LENGTH_LONG).show();
